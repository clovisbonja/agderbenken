...
Appen har også en mørk/lys-tema bryter i toppbaren for å veksle mellom tema.
...
3. Åpne nettleseren på http://localhost:5173 (eller porten som Vite viser)


## Hvordan bruke applikasjonen

- Naviger mellom sidene via topbar-menyen.
...
Spørsmål eller forslag — opprett en issue i repoet.
