...
const TEXT: Record<Lang, Record<string, string>> = {
  no: {
    statsLead: "Her finner du alle saker registrert i Stortingets API. Søk på tittel, filtrer på tema og åpne enkeltsakene for mer detaljer.",
    howToUse: "Slik bruker du siden",
    introStep1Title: "Finn saker",
    introStep1Text: "Bruk søkefeltet for å finne saker på tittel, komité, type, status eller saksnummer.",
    introStep2Title: "Filtrer på tema",
    introStep2Text: "Velg et tema for å se hvilke saker som hører inn under det.",
    introStep3Title: "Se statistikken",
    introStep3Text: "Lenger ned finner du nøkkeltall, statusfordeling og komitéaktivitet.",
    cases: "saker",
    session: "Sesjon",
  ...
  en: {
    statsLead: "Here you find all cases registered in the Storting API. Search by title, filter by theme and open individual cases for more details.",
    howToUse: "How to use this page",
    introStep1Title: "Find cases",
    introStep1Text: "Use the search field to find cases by title, committee, type, status or case number.",
    introStep2Title: "Filter by theme",
    introStep2Text: "Select a theme to see which cases fall under it.",
    introStep3Title: "Check the statistics",
    introStep3Text: "Further down you find key numbers, status distribution and committee activity.",
    cases: "cases",
    session: "Session",
